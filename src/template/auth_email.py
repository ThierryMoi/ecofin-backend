def generate_html(nom, prenom, code_validation,lien):
...
<div class="email-template">
    <div class="email-template__container">
        ...
        <div class="email-template__body">
            ...
            <p>Votre inscription à EDA a été réalisée avec succès. Bienvenue dans notre communauté !</p>
            <p>Votre code de validation est :</p>
            <div class="validation-code">
                <strong>{code_validation}</strong>
            </div>
            <br>            
