def generate_html_migration_depart(menom,meprenom, younom, youprenom, origine, residence):
    css_styles = """
    /* Ton code CSS ici */
    /* styles.css */
    ...
    <div class="email-template__container">
        <header class="email-template__header email-template-header">
            <div class="email-template-header__text">
                ...
                <span style="font-size: 18px;">Mauvaise nouvelle! 😊</span>
            </div>
        </header>
        <div class="email-template__body">
            <p>Helll <strong>{meprenom} {menom}</strong>,</p>
            <p>{youprenom} {younom} vient de quitter votre communauté pour une nouvelle destination : {residence} ! </p>
            <p>N'hesiter pas à lui souhaiter bonne chance pour cette nouvelle aventure. 🌍</p>
